            ...
            <div className="space-y-4 pt-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Your account is protected with industry-leading security</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Get access to all your policies in seconds</p>
                </div>
              </div>
            </div>
          </div>
